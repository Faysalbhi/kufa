                        ...
                        <div class="col-xl-12">
                            <div class="main-menu">
                                <nav class="navbar navbar-expand-lg">
                                    <a href="frontend_assets/index.html" class="navbar-brand logo-sticky-none"><img src="frontend_assets/img/logo/logo.png" alt="Logo"></a>
                                    ...
                                    <div class="collapse navbar-collapse" id="navbarNav">
                                        <ul class="navbar-nav ml-auto">
                                            <li class="nav-item active"><a class="nav-link" href="frontend_assets/#home">Home</a></li>
                                            <li class="nav-item"><a class="nav-link" href="frontend_assets/#about">about</a></li>
                                            <li class="nav-item"><a class="nav-link" href="frontend_assets/#service">service</a></li>
                                            <li class="nav-item"><a class="nav-link" href="frontend_assets/#portfolio">portfolio</a></li>
                                            <li class="nav-item"><a class="nav-link" href="frontend_assets/#contact">Contact</a></li>
                                        </ul>
                                    </div>
                        ...
                        <div class="col-xl-9 col-lg-10">
                            <div class="single-blog-list">
                                <div class="blog-list-thumb mb-35">
                                    <img src="frontend_assets/img/images/portfolio_details.jpg" alt="img">
                                </div>
                                    ...
                                    <div class="blog-list-meta">
                                        <ul>
                                            ...
                                            <li class="blog-post-share">
                                                <a href="frontend_assets/#"><i class="fab fa-facebook-f"></i></a>
                                                <a href="frontend_assets/#"><i class="fab fa-twitter"></i></a>
                                                <a href="frontend_assets/#"><i class="fab fa-pinterest-p"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <ul>
                                        <li>
                                            <div class="post-avatar-img">
                                                <img src="frontend_assets/img/blog/post_avatar_img.png" alt="img">
                                            </div>
