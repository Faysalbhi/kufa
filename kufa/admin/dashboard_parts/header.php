...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="/kufa/admin/dashboard_assets/images/favicon.png">
	  <link rel="stylesheet" href="/kufa/admin/dashboard_assets/vendor/chartist/css/chartist.min.css">
    <link href="/kufa/admin/dashboard_assets/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css">
	  <link href="/kufa/admin/dashboard_assets/vendor/owl-carousel/owl.carousel.css" rel="stylesheet">
    <link href="/kufa/admin/dashboard_assets/css/style.css" rel="stylesheet">
    <link href="/kufa/admin/dashboard_assets/css/profile.css" rel="stylesheet">
    <link href="/kufa/admin/dashboard_assets/css/form.css" rel="stylesheet">
    <link rel="stylesheet" href="/kufa/admin/dashboard_assets/css/flaticon.css">
    <link href="https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&family=Roboto:wght@100;300;400;500;700;900&display=swap" rel="stylesheet">
    <link rel="stylesheet" type="text/css" href="/kufa/admin/dashboard_assets/icons/fflaticon/flaticon.css">
    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="<?=$hostName?>admin/dashboard.php" class="brand-logo">
                <img class="logo-abbr" src="/kufa/admin/dashboard_assets/images/logo.png" alt="">
                <img class="logo-compact" src="/kufa/admin/dashboard_assets/images/logo-text.png" alt="">
                <img class="brand-title" src="/kufa/admin/dashboard_assets/images/logo-text.png" alt="">
            </a>
                  ...
                  <ul class="contacts">
                    ...
                    <li class="active dz-chat-user">
                      <div class="d-flex bd-highlight">
                        <div class="img_cont">
                          <img src="../dashboard_assets/images/avatar/1.jpg" class="rounded-circle user_img" alt=""/>
                    ...
                    <li class="dz-chat-user">
                      <div class="d-flex bd-highlight">
                        <div class="img_cont">
                          <img src="../dashboard_assets/images/avatar/2.jpg" class="rounded-circle user_img" alt=""/>
                    ...
                    <li class="dz-chat-user">
                      <div class="d-flex bd-highlight">
                        <div class="img_cont">
                          <img src="../dashboard_assets/images/avatar/3.jpg" class="rounded-circle user_img" alt=""/>
                          <span class="online_icon"></span>
                        </div>
                        <div class="user_info">
                ...
                <div class="card-body msg_card_body dz-scroll" id="DZ_W_Contacts_Body3">
                  <div class="d-flex justify-content-start mb-4">
                    <div class="img_cont_msg">
                      <img src="../dashboard_assets/images/avatar/1.jpg" class="rounded-circle user_img_msg" alt=""/>
                    </div>
                  ...
                  <div class="d-flex justify-content-end mb-4">
                    <div class="msg_cotainer_send">
                      ...
                      <div class="img_cont_msg">
                    <img src="../dashboard_assets/images/avatar/2.jpg" class="rounded-circle user_img_msg" alt=""/>
                      </div>
                  </div>
                  <div class="d-flex justify-content-start mb-4">
                    <div class="img_cont_msg">
            ...
            <div class="header-content">
											...
											<li>
												<div class="timeline-panel">
													<div class="media mr-2">
														<img alt="image" width="50" src="../dashboard_assets/images/avatar/1.jpg">
													</div>
                ...
                <a class="nav-link bell bell-link" href="javascript:void(0)">
                  <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
									...
									<div class="pulse-css "style="font-size:15px;text-align:center;padding-top:3px;"> 2</div>
                                </a>
							</li>
							<li class="nav-item dropdown notification_dropdown">
              ...
              <?php
              $id=$_SESSION['id'];
              $userselect="SELECT * FROM users WHERE id=$id";
              $db_user_tabel=mysqli_query($db_connect,$userselect);
              $users=mysqli_fetch_assoc($db_user_tabel);
              ?>
                  <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                      <img src="<?=$hostName?>admin/dashboard_assets/images/profile/<?=$users['profile_pic']?>" width="20" alt=""/>
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                      <a href="<?=$hostName?>admin/invoice/profile.php" class="dropdown-item ai-icon">
                          <svg id="icon-user1" xmlns="http://www.w3.org/2000/svg" class="text-primary" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                          <span class="ml-2">Profile </span>
                      </a>
                      <a href="/kufa/admin/dashboard_assets/email-inbox.html" class="dropdown-item ai-icon">
                          <svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" class="text-success" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                          <span class="ml-2">Inbox </span>
                      </a>
                      <a href="/kufa/admin/dashboard_assets/page-login.html" class="dropdown-item ai-icon">
        ...
        <div class="deznav">
              <div class="deznav-scroll">
                  <ul class="metismenu" id="menu">
                        ...
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                                    ...
                                    <span class="nav-text">User</span>
                                      ...
                                      <ul aria-expanded="false">
                                          <li><a href="<?=$hostName?>admin/user/all_user.php">All User</a></li>
                                          <li><a href="<?=$hostName?>admin/user/add_user.php">Add user</a></li>
                                      </ul>
                        </li>
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <span class="nav-text">Messages</span>
                              ...
                              <ul aria-expanded="false">
                                  <li><a href="<?=$hostName?>admin/message/all_messages.php">All Messages</a></li>
                              </ul>
                        </li>
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                                    ...
                                    <span class="nav-text">Banner</span>
                                      ...
                                      <ul aria-expanded="false">
                                          <li><a href="<?=$hostName?>admin/banner.php">Update Banner</a></li>
                        ...
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <ul aria-expanded="false">
                                <li><a href="<?=$hostName?>admin/service/add_servies.php">Add Services</a></li>
                                <li><a href="<?=$hostName?>admin/service/all_services.php">All Services</a></li>
                        ...
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <span class="nav-text">Portfolios</span>
                              ...
                              <ul aria-expanded="false">
                                  <li><a href="<?=$hostName?>admin/portfolio/all_portfolios.php">All Portfolio</a></li>
                                  <li><a href="<?=$hostName?>admin/portfolio/add_portfolios.php">Add Portfolio</a></li>
                              </ul>
                        </li>
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <span class="nav-text">Achievements</span>
                              ...
                              <ul aria-expanded="false">
                                  <li><a href="<?=$hostName?>admin/achievement/all_achievement.php">All Achievement</a></li>
                                  <li><a href="<?=$hostName?>admin/achievement/add_achievement.php">Add Achievement</a></li>
                              </ul>
                        </li>
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            ...
                            <span class="nav-text">Testimonial</span>
                              ...
                              <ul aria-expanded="false">
                                  <li><a href="<?=$hostName?>admin/testimonial/all_testimonial.php">All Testimonial</a></li>
                                  <li><a href="<?=$hostName?>admin/testimonial/add_testimonial.php">Add Testimonial</a></li>
                              </ul>
                        </li>
                        <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-news"></i>
                            <span class="nav-text">Our Member</span>
                           </a>
                              <ul aria-expanded="false">
                                  <li><a href="<?=$hostName?>admin/member/add_member.php">Add Member</a></li>
                                  <li><a href="<?=$hostName?>admin/member/all_member.php">All Member</a></li>
                              </ul>
                        </li>
                        
                        <li><a href="<?=$hostName?>admin/about_me.php" class="ai-icon" aria-expanded="false">
                            <i class="flaticon-381-bookmark"></i>
                            <span class="nav-text">Avout Me</span>
                          </a>
										    </li>
                        <li><a href="<?=$hostName?>admin/eduqualification.php" class="ai-icon" aria-expanded="false">
                            <i class="fa-solid fa-award"></i>
                            <span class="nav-text">Educational Qulaifiacation</span>
                            </a>
										    </li>
                         <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="fa-solid fa-screwdriver-wrench"></i>
                            <span class="nav-text">Settngs</span>
                           </a>
                              <ul aria-expanded="false">
                                  <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Frontend Logo</a>
                                      <ul aria-expanded="false">
                                          <li><a href="<?=$hostName?>admin/logo/add_logo.php">Add Logo</a></li>
                                          <li><a href="<?=$hostName?>admin/logo/all_logo.php">All Logo</a></li>
                                      </ul>
                                  </li>
                                  <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Frontend Menu</a>
                                      <ul aria-expanded="false">
                                          <li><a href="<?=$hostName?>admin/menu/add_menu.php">Add Menu</a></li>
                                          <li><a href="<?=$hostName?>admin/menu/all_menu.php">All Menu</a></li>
                                      </ul>
                                  </li>  
                                  <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Social Icon</a>
                                      <ul aria-expanded="false">
                                          <li><a href="<?=$hostName?>admin/social_icon/add_social_icon.php">Add Icon</a></li>
                                          <li><a href="<?=$hostName?>admin/social_icon/all_social_icon.php">All Icon</a></li>
                                      </ul>
                                  </li>
                                  <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Contuct Information</a>
                                      <ul aria-expanded="false">
                                          <li><a href="<?=$hostName?>admin/update_info.php">Update Contuct</a></li>
                                      </ul>
                                  </li>
                                  <li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Frontend Footer</a>
                                      <ul aria-expanded="false">
                                          <li><a href="<?=$hostName?>admin/update_footer.php">Update Footer</a></li>
                                      </ul>
                                  </li>
                              </ul>
                        </li>
                  ...
                  <div class="add-menu-sidebar">
                    <img src="../dashboard_assets/images/calendar.png" alt="" class="mr-3">
